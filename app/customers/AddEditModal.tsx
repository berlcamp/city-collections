...
// Types
import { LocationTypes, type CustomerTypes } from "@/types/index";
...
const AddEditModal = ({ hideModal, editData }: ModalProps) => {
  ...
  const onSubmit = async (formdata: CustomerTypes) => {
    if (saving) return;
  ...
  const handleCreate = async (formdata: CustomerTypes) => {
    try {
      const newData = {
        name: formdata.name,
  ...
  const handleUpdate = async (formdata: CustomerTypes) => {
    if (!editData) return;
        ...
        <div className="app__modal_wrapper2">
          <div className="app__modal_wrapper3">
            <div className="app__modal_header">
              <h5 className="app__modal_header_text">Customer Details</h5>
              <button
                disabled={saving}
                onClick={hideModal}
                type="button"
                ...
                <>
                  <div className="app__form_field_container">
                    <div className="w-full">
                      <div className="app__label_standard">Customer Name</div>
                      <div>
                        <input
